...
@endverbatim
 */
#ifndef TM_SERVOKamera_H
#define TM_SERVOKamera_H 110
 ...
 */
typedef enum {
	TM_SERVOKamera_Result_Ok = 0, /*!< Everything OK */
	TM_SERVOKamera_Result_Error   /*!< An error occurred somewhere */
} TM_SERVOKamera_Result_t;
